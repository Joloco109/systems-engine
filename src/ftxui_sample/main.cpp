...
// configuration step. It creates a namespace called `systems_engine`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", systems_engine::cmake::project_name, systems_engine::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", systems_engine::cmake::project_version);
      return EXIT_SUCCESS;
    }
